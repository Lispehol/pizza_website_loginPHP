                ...
                <?php foreach ($users as $user): ?>
                    <tr>
                        <form action='delete.php?login="<?php echo $user['login']; ?>"' method="post">
                            <td>
                                <input type="text" name="editfname" value="<?php echo $user['firstname']; ?>">
                            </td>
                            <td>
                                <input type="text" name="editlname" value="<?php echo $user['lastname']; ?>">
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="deleteLogin" value="<?php echo $user['login']; ?>">
                            </td>
                        </form>
                    </tr>
                    <?php endforeach; 
